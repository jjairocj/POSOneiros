...
- [[17-Despliegue-Docker-CasaOS]] — imagen Docker y despliegue en CasaOS (red local)
- [[18-Offline-First-POS]] — roadmap del POS offline-first (catálogo local, PWA, reconciliación)
